<i18n>
{
  "ja": {
    ...
    "text02": "※こちらのツールで入力された情報は、本サイトのユーザビリティの向上を目的とし、ブラウザ上に一時保存されます。"
  },
  "en": {
    "meta": {
    ...
    "text02": "Note: Information entered in this tool is temporarily stored in your browser to improve site usability."
  }
}
</i18n>
    ...
    <div class="PageBlock">
      <section class="Container -s">
        ...
        <div class="Container -xs">
          ...
          <p class="PageBlock__text ToolLead__note">
            {{ $t('text02') }}
          </p>
        </div>
      </section>
...
export default {
  ...
  methods: {
    goToNextStep() {
      ...
      const top = document.querySelector(`.ToolStep0${currentStep}`).getBoundingClientRect().top + window.scrollY
